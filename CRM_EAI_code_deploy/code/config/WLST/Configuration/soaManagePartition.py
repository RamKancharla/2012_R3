...
def main():
	...
	SOAServerURL=configProps.getProperty("domain1.AdminIP")
	SOAServerPort=configProps.getProperty("domain1.AdminPort")
	soaUserName="weblogic"
	soaPassword=configProps.getProperty("domain1.AdminPasswd")
	connect(soaUserName,soaPassword,sys.argv[1])	
