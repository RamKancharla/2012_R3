...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [FRI JUL 09 14:11:29 GMT+05:30 2010]. -->
?>
      ...
      <xsdLocal1:ContactExternalIO>
        ...
        <xsdLocal1:Contact>
          ...
          <xsdLocal1:RcrmContactLoginId>
            <xsl:if test="not(starts-with(/local:UpdateProfileRequest/local:UpdateProfileUserDetails/local:_CPFGStatusReason,&quot;001&quot;))">
