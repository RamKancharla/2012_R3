...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON MAR 30 14:46:16 GMT+05:30 2009]. -->
?>
    ...
    <ns0:basicResponse>
      ...
      <ns0:basicResponse>
        <gcap-message:response>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;FailureCode&quot;,&quot;Value&quot;,1.0)"/>
        </gcap-message:response>
        ...
        <gcap-message:responseMessage>
          <xsl:value-of select="string(&quot;UNKNOWN ERROR&quot;)"/>
        </gcap-message:responseMessage>
      </ns0:basicResponse>
    </ns0:basicResponse>
  </xsl:template>
