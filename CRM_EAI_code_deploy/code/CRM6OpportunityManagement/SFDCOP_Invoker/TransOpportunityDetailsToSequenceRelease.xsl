...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="http://ukcq-eai03:7777/orabpel/ccrmasync/SequenceReleaser/EAI.MSG.UTL.187_ReleaseSequenceRequest.xsd"/>
      <rootElement name="releaseSequenceRequest" namespace="http://www.reuters.com/ns/2007/09/01/GCAP/UTL/Sequencer"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON OCT 05 14:10:08 GMT+05:30 2009]. -->
?>
