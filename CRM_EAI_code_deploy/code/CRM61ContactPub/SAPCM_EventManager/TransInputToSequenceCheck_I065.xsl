  ...
  <xsl:template match="/">
    <xsdLocal:checkSequenceRequest>
      <xsdLocal:eaiHeader>
        ...
        <gcap-cmt:tracingId>
          <xsl:value-of select="concat(&quot;I065_&quot;,/local:contactEvent/local:eaiHeader/gcap-cmt:tracingId)"/>
        </gcap-cmt:tracingId>
        <gcap-cmt:timeStamp>
      ...
      <xsdLocal:seqRequestDetails>
        <xsdLocal:context>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SequenceContextForSAPContact&quot;,&quot;Value&quot;,&quot;SAPCMEventManager&quot;)"/>
        </xsdLocal:context>
        <xsdLocal:messageType>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SequencerMessageTypeForSAPContactSync&quot;,&quot;Value&quot;,&quot;SAP.ContactROWID&quot;)"/>
        </xsdLocal:messageType>
        <xsdLocal:contextId>
          <xsl:value-of select="/local:contactEvent/local:contact/local:ContactRowId"/>
        </xsdLocal:contextId>
        <xsdLocal:process>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SAPCMEventManagerProcess&quot;,&quot;Value&quot;,&quot;SAPCM_EventManager&quot;)"/>
        </xsdLocal:process>
