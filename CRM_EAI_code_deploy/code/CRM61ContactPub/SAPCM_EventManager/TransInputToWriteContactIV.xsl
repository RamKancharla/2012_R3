  ...
  <xsl:template match="/">
    <ns0:InterfaceBufferCollection>
      <ns0:InterfaceBuffer>
        ...
        <ns0:interfaceId>
          <xsl:text disable-output-escaping="no">SAPCM</xsl:text>
        </ns0:interfaceId>
        <ns0:referenceId>
