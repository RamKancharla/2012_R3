...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE SEP 08 22:19:36 BST 2009]. -->
?>
    ...
    <xsdLocal:checkSequenceRequest>
      ...
      <xsdLocal:seqRequestDetails>
        ...
        <xsdLocal:messageType>
          <xsl:text disable-output-escaping="no">AccountDetails.MasterAccountID</xsl:text>
        </xsdLocal:messageType>
        <xsdLocal:contextId>
          <xsl:value-of select="/local:contactEvent/local:contact/local:masterAccountID"/>
        </xsdLocal:contextId>
        <xsdLocal:process>
          <xsl:text disable-output-escaping="no">CPFGCM_ContactManager</xsl:text>
        </xsdLocal:process>
