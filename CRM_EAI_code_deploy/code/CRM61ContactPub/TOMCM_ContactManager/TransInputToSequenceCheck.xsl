...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="http://eaidev2:7777/orabpel/ccrmasync/AsyncSequenceChecker/EAI.MSG.UTL.185_CheckSequenceRequest.xsd"/>
      <rootElement name="checkSequenceRequest" namespace="http://www.reuters.com/ns/2007/09/01/GCAP/UTL/Sequencer"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU JAN 28 12:17:43 GMT 2010]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:checkSequenceRequest>
      ...
      <xsdLocal:seqRequestDetails>
        <xsdLocal:context>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SequenceContextForTOMContact&quot;,&quot;Value&quot;,&quot;TOMContactManager&quot;)"/>
        </xsdLocal:context>
        <xsdLocal:messageType>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SequencerMessageTypeContact&quot;,&quot;Value&quot;,&quot;ContactDetails.ContactID&quot;)"/>
        </xsdLocal:messageType>
        <xsdLocal:contextId>
          <xsl:value-of select="/local:contactEvent/local:contact/local:UUID"/>
        </xsdLocal:contextId>
        <xsdLocal:process>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;TOMContactManagerBPELProcess&quot;,&quot;Value&quot;,&quot;TOMCM_ContactManager&quot;)"/>
        </xsdLocal:process>
