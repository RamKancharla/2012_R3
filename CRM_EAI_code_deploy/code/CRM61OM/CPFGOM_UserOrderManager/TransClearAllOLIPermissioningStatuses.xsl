...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.3.0(build 100415.2045.2557) AT [TUE DEC 13 14:11:04 GMT+05:30 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl ns0 xsd xsdLocal cmt bpws xp20 mhdr bpel2 orcl dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <xsdLocal:orderRequest>
      ...
      <xsdLocal:user>
        <xsl:value-of select="/xsdLocal:orderRequest/xsdLocal:user"/>
      </xsdLocal:user>
    </xsdLocal:orderRequest>
  </xsl:template>
</xsl:stylesheet>
