...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.3.0(build 100415.2045.2557) AT [TUE DEC 13 15:57:17 GMT+05:30 2011]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl ns1 xsd xsdLocal cmt ns0 bpws xp20 mhdr bpel2 orcl dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <ns0:orderStatus>
      <ns0:eaiHeader>
        <cmt:applicationId>
      ...
      <xsl:for-each select="/xsdLocal:orderRequest/xsdLocal:orderLineItem">
        <xsl:if test='(xsdLocal:permissioningStatus != "COMPLETE") and (xsdLocal:businessCase = "User Swap")'>
          <ns0:orderLineItem>
            <ns0:CRMOLIId>
