...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="assertExecuteWatchStatelessDecision" namespace="http://www.reuters.com/ns/2007/09/01/GCAP/EAI/OM/OrderLineStatusWebDAVDecisionService"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="XSD">
