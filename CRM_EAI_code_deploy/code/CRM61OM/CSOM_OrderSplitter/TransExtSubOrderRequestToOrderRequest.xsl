    ...
    <ns0:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extSubcriberOrderRequest/xsdLocal:orderLineItem">
        <ns0:orderLineItem>
          ...
          <xsl:choose>
            <xsl:when test="string-length(xsdLocal:subscriber) > 7.0">
              <ns0:subscriber>
            ...
            <xsl:otherwise>
              <ns0:subscriber>
                <xsl:value-of select="concat(xsdLocal:subscriberCountryCode,xsdLocal:subscriberNumber)"/>
              </ns0:subscriber>
            </xsl:otherwise>
          </xsl:choose>
          <ns0:subAccount>
