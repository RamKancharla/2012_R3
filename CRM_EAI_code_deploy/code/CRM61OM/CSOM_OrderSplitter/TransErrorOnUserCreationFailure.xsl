...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE FEB 24 10:11:40 GMT 2009]. -->
?>
  ...
  <xsl:template match="/">
    <ns1:orderStatus>
      ...
      <xsl:for-each select="/xsdLocal:CSOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="xsdLocal:isNewUser != &quot;Y&quot;">
          <ns1:orderLineItem>
            <ns1:CRMOLIId>
            ...
            <ns1:orderPermissionStatusToBeSent>
