...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [WED MAR 14 00:55:09 GMT+05:30 2012]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <xsdLocal:distinctUserIdRequest>
      <xsdLocal:eaiHeader>
        <cmt:applicationId>
      ...
      <xsl:for-each select="/xsdLocal:orderRequest/xsdLocal:orderLineItem">
        <xsdLocal:orderLineItem>
          ...
          <!--   <xsdLocal:extraInfo>
            <xsl:copy-of select="xsdLocal:extraInfo"/>
          </xsdLocal:extraInfo>-->
          <xsdLocal:extraInfo>
