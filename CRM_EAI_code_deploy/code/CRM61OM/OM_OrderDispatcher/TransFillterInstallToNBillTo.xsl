...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED MAR 09 14:49:03 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:extendedOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="starts-with(xsdLocal:nextAction1,&quot;Create Order&quot;) or (starts-with(xsdLocal:nextAction1,&quot;Create Install Order&quot;) or starts-with(xsdLocal:nextAction3,&quot;Create Bill Order&quot;))">
