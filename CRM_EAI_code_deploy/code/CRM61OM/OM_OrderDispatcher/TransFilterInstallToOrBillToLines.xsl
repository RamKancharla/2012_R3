...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  <mapSources>
    <source type="XSD">
      <schema location="../../../../../../../Documents%20and%20Settings/Surya.Gannavarapu/Desktop/Sprint10%20-%20Release2/CRM61OM/OM_OrderDispatcher/bpel/EAI.MSG.OM.193_ExtendedOrderRequest.xsd"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON APR 05 23:28:10 BST 2010]. -->
?>
    ...
    <xsdLocal:extendedOrderRequest>
      ...
      <xsdLocal:orderHeader>
        ...
        <xsdLocal:expectedTRTMDate>
          <xsl:value-of select="/xsdLocal:extendedOrderRequest/xsdLocal:orderHeader/xsdLocal:expectedTRTMDate"/>
        </xsdLocal:expectedTRTMDate>
      </xsdLocal:orderHeader>
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="starts-with(xsdLocal:nextAction1,&quot;Create Install Order&quot;) or starts-with(xsdLocal:nextAction3,&quot;Create Bill Order&quot;)">
          <xsdLocal:orderLineItem>
            ...
            <xsdLocal:SAPIntegrationFlag>
              <xsl:value-of select="xsdLocal:SAPIntegrationFlag"/>
            </xsdLocal:SAPIntegrationFlag>
            <xsdLocal:PDPCode>
