...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED MAR 09 14:45:40 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="starts-with(xsdLocal:nextAction3,&quot;Create Bill Order&quot;)">
          <ns0:orderLineItem>
            <ns0:CRMOLIId>
