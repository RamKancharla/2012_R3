...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="http://inkaban3ua-eai03:7777/orabpel/ccrmasync/CSOM_OrderSplitter/EAI.MSG.OM.259_OrderRequest.xsd"/>
      <rootElement name="CSOrderRequest" namespace="http://www.reuters.com/ns/2007/01/25/GCAP/EAI/CS/OrderRequest"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON OCT 11 14:14:40 GMT+05:30 2010]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="contains(xsdLocal:nextAction1,&quot;RTB&quot;)">
          <ns0:orderLineItem>
            <ns0:CRMOLIId>
