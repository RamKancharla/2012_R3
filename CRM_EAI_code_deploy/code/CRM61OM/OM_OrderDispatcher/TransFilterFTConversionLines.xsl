...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE APR 12 12:19:25 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="contains(xsdLocal:nextAction1,&quot;FT Conversion&quot;)">
          <ns0:orderLineItem>
            <ns0:CRMOLIId>
