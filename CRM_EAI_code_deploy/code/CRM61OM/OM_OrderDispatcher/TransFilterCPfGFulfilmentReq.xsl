...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.3.0(build 100415.2045.2557) AT [WED DEC 14 12:38:43 GMT+05:30 2011]. -->
?>
    ...
    <xsdLocal:orderRequest>
      ...
      <xsdLocal:orderHeader>
        ...
        <xsdLocal:AAATransactionId>
          <xsl:value-of select="/xsdLocal:extendedOrderRequest/xsdLocal:orderHeader/xsdLocal:AAATransactionId"/>
        </xsdLocal:AAATransactionId>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test='xp20:ends-with(xsdLocal:nextAction1,"CPfG Fulfilment") or xp20:ends-with(xsdLocal:nextAction4,"CPfG Fulfilment")'>
