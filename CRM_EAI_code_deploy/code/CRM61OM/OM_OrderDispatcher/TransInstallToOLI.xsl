...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED MAR 09 14:44:43 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="starts-with(xsdLocal:nextAction1,&quot;Create Install Order&quot;)">
          <ns0:orderLineItem>
            <ns0:CRMOLIId>
            ...
            <ns0:permBillFlag>
              <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;InstallToOrderRequest&quot;,&quot;Value&quot;,&quot;P&quot;)"/>
            </ns0:permBillFlag>
