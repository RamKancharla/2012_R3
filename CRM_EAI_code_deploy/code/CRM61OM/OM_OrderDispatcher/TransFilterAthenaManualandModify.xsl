...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [TUE APR 12 12:05:02 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:extendedOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="starts-with(xsdLocal:nextAction1,&quot;Create Athena User&quot;) or (starts-with(xsdLocal:nextAction1,&quot;Create Athena Order&quot;) or (starts-with(xsdLocal:nextAction1,&quot;Athena Manual Permission&quot;) or starts-with(xsdLocal:nextAction1,&quot;Athena Create AKR&quot;)))">
