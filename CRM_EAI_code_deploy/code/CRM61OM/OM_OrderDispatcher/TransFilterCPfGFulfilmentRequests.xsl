...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON MAR 15 00:11:46 GMT 2010]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:orderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="xp20:ends-with(xsdLocal:nextAction1,&quot;CPfG Fulfilment&quot;)">
