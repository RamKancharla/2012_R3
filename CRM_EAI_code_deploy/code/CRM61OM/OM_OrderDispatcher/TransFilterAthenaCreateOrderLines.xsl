...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON APR 05 23:05:24 BST 2010]. -->
?>
  ...
  <xsl:template match="/">
    <ns1:CSOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:extendedOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="(xsdLocal:nextAction1 = &quot;Create Athena User&quot;) or starts-with(xsdLocal:nextAction1,&quot;Create Athena Order&quot;)">
          <ns1:orderLineItem>
            <ns1:CRMOLIId>
