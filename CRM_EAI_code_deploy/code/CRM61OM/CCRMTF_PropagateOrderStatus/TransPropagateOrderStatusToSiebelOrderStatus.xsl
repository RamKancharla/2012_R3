...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="InboundTOMOrder.wsdl"/>
      <rootElement name="SiebelMessage" namespace=""/>
      <rootElementDatatype name="OrderRequestTopElmt" namespace="http://www.siebel.com/xml/RCRM%20Order%20Entry"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [MON AUG 18 10:47:29 BST 2008]. -->
?>
          ...
          <xsl:if test="count(/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem[xsdLocal:CRMOLIId != &quot;&quot;]) > 0.0">
            <ns0:OrderEntry-LineItems>
              <ns0:RCRMTechnicalFulfillmentStatus>
                <xsl:value-of select="dvm:lookupValue('oramds:/apps/EAIMetaData/dvm/CCRMTF_TechFulfilmentStatusMap.dvm','TOM_OLI_STATUS',/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:technicalFulfilmentStatus,'CRM_OLI_STATUS',/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:technicalFulfilmentStatus)"/>
              </ns0:RCRMTechnicalFulfillmentStatus>
              <xsl:if test="/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:plannedInstallationDate != &quot;&quot;">
                <ns0:RCRMPlannedInstallationDate>
                  <xsl:value-of select="xp20:format-dateTime(/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:plannedInstallationDate,&quot;[M01]/[D01]/[Y0001]&quot;)"/>
                </ns0:RCRMPlannedInstallationDate>
              </xsl:if>
              <xsl:if test="/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:actualInstallationDate != &quot;&quot;">
                <ns0:RCRMActualInstallationDate>
                  <xsl:value-of select="xp20:format-dateTime(/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:actualInstallationDate,&quot;[M01]/[D01]/[Y0001]&quot;)"/>
                </ns0:RCRMActualInstallationDate>
              </xsl:if>
              <ns0:Id>
                <xsl:value-of select="/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:CRMOLIId"/>
              </ns0:Id>
            </ns0:OrderEntry-LineItems>
          </xsl:if>
        </ns0:OrderEntry-Orders>
