...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="http://inkaban3ua-eai01:7777/orabpel/ccrmasync/CCRMOM_PropagateOrderStatus/EAI.MSG.OM.225_OrderStatus.xsd"/>
      <rootElement name="crmOrderStatus" namespace="http://www.reuters.com/NS/2007/01/25/GCAP/EAI/OrderManagement/CCRM"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU NOV 25 12:35:36 GMT+05:30 2010]. -->
?>
    ...
    <ns0:crmOrderStatus>
      ...
      <xsl:for-each select="/xsdLocal:orderStatus/xsdLocal:orderLineItem">
        <ns0:orderLineItem>
          ...
          <xsl:if test="(xsdLocal:field2 != &quot;StatusType=Permissioning&quot;) and ((xsdLocal:permissioningSystem != &quot;Athena&quot;) or (xsdLocal:orderLinestatus != &quot;Permissioned&quot;))">
            <ns0:orderLineStatusReasonCode>
              <xsl:value-of select="xsdLocal:requestStatus"/>
            </ns0:orderLineStatusReasonCode>
          </xsl:if>
          <xsl:if test="(xsdLocal:field2 = &quot;StatusType=Permissioning&quot;) or ((xsdLocal:permissioningSystem = &quot;Athena&quot;) and (xsdLocal:orderLinestatus = &quot;Permissioned&quot;))">
