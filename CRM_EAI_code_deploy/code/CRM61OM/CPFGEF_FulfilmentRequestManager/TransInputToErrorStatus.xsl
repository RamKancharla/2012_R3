  ...
  <xsl:template match="/">
    <ns0:orderStatusUpdate>
      ...
      <ns0:orderLineItem>
        ...
        <ns0:permissioningStatusReasonCode>
          <xsl:text disable-output-escaping="no">00300-EAI</xsl:text>
        </ns0:permissioningStatusReasonCode>
      </ns0:orderLineItem>
    </ns0:orderStatusUpdate>
  </xsl:template>
