...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="../../../../B2CC%20Process/SAPOM_EventManager/SAPOM_EventManager/bpel/WriteContact_table.xsd"/>
      <rootElement name="InterfaceBufferCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/WriteContact"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [FRI MAR 26 15:18:47 GMT+05:30 2010]. -->
?>
  ...
  <xsl:template match="/">
    <ns0:InterfaceBufferCollection>
      <ns0:InterfaceBuffer>
        ...
        <ns0:interfaceId>
          <xsl:value-of select="string(&quot;SAPOM&quot;)"/>
        </ns0:interfaceId>
        <ns0:referenceId>
