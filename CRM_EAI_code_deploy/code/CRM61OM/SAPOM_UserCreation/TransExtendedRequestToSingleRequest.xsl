...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED JAN 12 12:27:49 GMT+05:30 2011]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:SAPOrderRequest>
      ...
      <xsl:for-each select="/xsdLocal:SAPOrderRequest/xsdLocal:orderLineItem">
        <xsl:if test="../xsdLocal:eaiHeader/cmt:messageHistory = xsdLocal:userNumber">
