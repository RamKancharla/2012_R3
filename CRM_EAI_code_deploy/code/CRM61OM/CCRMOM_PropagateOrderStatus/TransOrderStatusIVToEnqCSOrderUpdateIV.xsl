...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [WED OCT 13 17:41:46 GMT+05:30 2010]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal1:OrderRequest>
      ...
      <xsdLocal1:OrderEntry-Orders>
        ...
        <xsl:choose>
          <xsl:when test="/xsdLocal:crmOrderStatus/xsdLocal:orderLineItem/xsdLocal:SAPOrderNumber != &quot;&quot;">
