...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.4.0(build 110106.1932.5682) AT [WED MAR 14 00:37:31 GMT+05:30 2012]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <xsdLocal:orderRequest>
      <xsdLocal:eaiHeader>
        <cmt:applicationId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:applicationId"/>
        </cmt:applicationId>
        <cmt:transactionId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:transactionId"/>
        </cmt:transactionId>
        <cmt:messageId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:messageId"/>
        </cmt:messageId>
        <cmt:messageHistory>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:messageHistory"/>
        </cmt:messageHistory>
        <cmt:tracingId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:tracingId"/>
        </cmt:tracingId>
        <cmt:timeStamp>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:timeStamp"/>
        </cmt:timeStamp>
        <cmt:instanceId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:instanceId"/>
        </cmt:instanceId>
        <cmt:timeToLive>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:timeToLive"/>
        </cmt:timeToLive>
        <cmt:payloadVersion>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:eaiHeader/cmt:payloadVersion"/>
        </cmt:payloadVersion>
      </xsdLocal:eaiHeader>
      <xsdLocal:logicalCountry>
        <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:logicalCountry"/>
      </xsdLocal:logicalCountry>
      <xsdLocal:messageHeader>
        <xsdLocal:actionCode>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:messageHeader/xsdLocal:actionCode"/>
        </xsdLocal:actionCode>
        <xsdLocal:version>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:messageHeader/xsdLocal:version"/>
        </xsdLocal:version>
        <xsdLocal:userId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:messageHeader/xsdLocal:userId"/>
        </xsdLocal:userId>
      </xsdLocal:messageHeader>
      <xsdLocal:orderHeader>
        <xsdLocal:CRMOrderNumber>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:CRMOrderNumber"/>
        </xsdLocal:CRMOrderNumber>
        <xsdLocal:AAATransactionId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:AAATransactionId"/>
        </xsdLocal:AAATransactionId>
        <xsdLocal:installDate>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:installDate"/>
        </xsdLocal:installDate>
        <xsdLocal:removalDate>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:removalDate"/>
        </xsdLocal:removalDate>
        <xsdLocal:po>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:po"/>
        </xsdLocal:po>
        <xsdLocal:orderNote>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:orderNote"/>
        </xsdLocal:orderNote>
        <xsdLocal:orderStatus>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:orderStatus"/>
        </xsdLocal:orderStatus>
        <xsdLocal:ssPersonId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:ssPersonId"/>
        </xsdLocal:ssPersonId>
        <xsdLocal:slPersonId>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:slPersonId"/>
        </xsdLocal:slPersonId>
        <xsdLocal:expectedTRTMDate>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:expectedTRTMDate"/>
        </xsdLocal:expectedTRTMDate>
        <xsdLocal:orderOwner>
          <xsl:value-of select="/xsdLocal:UserIdRequest/xsdLocal:orderHeader/xsdLocal:orderOwner"/>
        </xsdLocal:orderOwner>
      </xsdLocal:orderHeader>
      <xsl:for-each select="/xsdLocal:UserIdRequest/xsdLocal:orderLineItem[(position() >= ../xsdLocal:PositionIndex) and (position() &lt;= ../xsdLocal:PositionN)]">
