...
public class OpptiesSiebelToTRUST
{
public OpptiesSiebelToTRUST(String s)
    {
    }  
 ...
 // column keys...
    ...
    public static JFreeChart createChart(CategoryDataset dataset) {
           ...
           JFreeChart jfreechart = ChartFactory.createBarChart(
               "Oppties - Siebel To TRUST Transaction",         // chart title
    ...
    {
        OpptiesSiebelToTRUST OpptiesSiebelToTRUST = new OpptiesSiebelToTRUST("JFreeChart: OpptiesSiebelToTRUST");
            }
}