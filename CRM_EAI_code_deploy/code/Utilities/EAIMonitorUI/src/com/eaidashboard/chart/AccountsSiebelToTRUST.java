...
public class AccountsSiebelToTRUST
{
    public AccountsSiebelToTRUST(String s)
    {
    }
    ...
    public static JFreeChart createChart(CategoryDataset dataset) {
           ...
           JFreeChart jfreechart = ChartFactory.createBarChart(
               "Accounts - Siebel To TRUST Transaction",         // chart title
 ...
 public static void main(String args[])
    {
        AccountsSiebelToTRUST AccountsSiebelToTRUST = new AccountsSiebelToTRUST("JFreeChart: AccountsSiebelToTRUST");
           }
}