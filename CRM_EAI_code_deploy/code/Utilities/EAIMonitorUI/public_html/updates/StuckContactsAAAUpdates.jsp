        ...
        <table width="100%" >
            ...
            <tr>
             <td style="font-weight:bold; color:darkBlue">
                 <center> <h2>CPFG To Siebel-Stuck Contacts</h2></center>
                </td>
            </tr>
            <tr>
        ...
        <table  cellpadding="4"  class="litebluetableborder"  width="100%">
            <thead >
                  ...
                  <tr  id="headerTR1" class="tableHeader ">
                        ...
                        <th class="bodytextbold " style="font-size:14; font-family:Verdana"><b>N S Insatnce ID</b></th>
            ...
            <tbody>
                     <%
                       ...
                       try{
                           ...
                           stuckContactsAAAUpdatesBean=(StuckContactsAAAUpdatesBean)stuckContactsAAAUpdates.get(i);
                            if(i%2==0){%>
                                 <tr class="tbbg1">
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getContactRowId()%></td>
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getStatus()%></td>
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getCheckerInstanceId()%></td>
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getReleaserInstanceId()%></td>
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getNSInstanceId()%></td>
                                       <td class="bodytext tableRowGrey" align="center" ><%=stuckContactsAAAUpdatesBean.getLastUpdatedDate()%></td>
                                </tr> 
                               <%} else{%>   
                                   <tr class="tbbg1">
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getContactRowId()%></td>
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getStatus()%></td>
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getCheckerInstanceId()%></td>
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getReleaserInstanceId()%></td>
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getNSInstanceId()%></td>
                                       <td class="bodytext tableRowBlue" align="center" ><%=stuckContactsAAAUpdatesBean.getLastUpdatedDate()%></td>
                                   </tr> 
                             <% } 
                             }
                                }catch(Exception e){
