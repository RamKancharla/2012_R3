...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="http://eaidev2:8888/orabpel/SandBox/CSPM_PropagatePriceUpdatesToCS/EAI.MSG.CS.PM.212_CSPriceUpdateRequest.xsd"/>
      <rootElement name="priceUpdateRequest" namespace="http://www.reuters.com/ns/2007/09/01/GCAP/EAI/CS/PM/PriceUpdate"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU APR 24 13:47:25 BST 2008]. -->
?>
