    ...
    <xsdLocal:PricePublish>
      ...
      <xsdLocal:PriceList>
        ...
        <xsdLocal:PriceListItem>
          <xsdLocal:Id>
            <xsl:value-of select="/xsdLocal:PricePublish/xsdLocal:PriceList/xsdLocal:PriceListItem/xsdLocal:Id"/>
          </xsdLocal:Id>
        </xsdLocal:PriceListItem>
      ...
      <xsdLocal:Timestamp>
        <xsl:value-of select="/xsdLocal:PricePublish/xsdLocal:Timestamp"/>
      </xsdLocal:Timestamp>
