...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 10.1.3.3.0(build 070615.0525) AT [THU FEB 11 19:10:57 GMT+05:30 2010]. -->
?>
  ...
  <xsl:template match="/">
    <xsdLocal:CSPublishAccountValidateRequest>
      <xsdLocal:eaiHeader>
        ...
        <xsdLocal:timeStamp>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:eaiHeader/gcap-cmt:timeStamp"/>
        </xsdLocal:timeStamp>
        <xsdLocal:instanceId>
      ...
      <xsdLocal:messageHeader>
        ...
        <gcap-cmt:timeStamp>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:messageHeader/gcap-cmt:timeStamp"/>
        </gcap-cmt:timeStamp>
        <gcap-cmt:userId>
      ...
      <xsdLocal:country>
        <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:country"/>
      </xsdLocal:country>
      <xsdLocal:actionCode>
      ...
      <xsdLocal:account>
        ...
        <xsdLocal:accountDescription>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:account/ns1:accountDescription"/>
        </xsdLocal:accountDescription>
        <xsdLocal:accountNotes>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:account/ns1:accountNotes"/>
        </xsdLocal:accountNotes>
        <xsdLocal:customerReference>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:account/ns1:customerReference"/>
        </xsdLocal:customerReference>
      ...
      <xsl:for-each select="/ns1:CSPublishAccountContactRequest/ns1:address">
        <xsdLocal:address>
          ...
          <xsdLocal:building>
            <xsl:value-of select="ns1:building"/>
          </xsdLocal:building>
          <xsdLocal:street>
      ...
      <xsl:for-each select="/ns1:CSPublishAccountContactRequest/ns1:contact">
        <xsdLocal:contact>
          <xsdLocal:contactId>
            <xsl:value-of select="ns1:contactId"/>
          </xsdLocal:contactId>
      ...
      <xsdLocal:countryAttributes>
        ...
        <xsdLocal:RIPurchaseOrder>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:CountrySpecAttributes/ns1:RIPurchaseOrder"/>
        </xsdLocal:RIPurchaseOrder>
        <xsdLocal:ERPurchaseOrder>
          <xsl:value-of select="/ns1:CSPublishAccountContactRequest/ns1:CountrySpecAttributes/ns1:ERPurchaseOrder"/>
        </xsdLocal:ERPurchaseOrder>
      </xsdLocal:countryAttributes>
    </xsdLocal:CSPublishAccountValidateRequest>
  </xsl:template>
