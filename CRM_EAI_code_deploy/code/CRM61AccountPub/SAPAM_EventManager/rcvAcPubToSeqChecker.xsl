  ...
  <xsl:template match="/">
    <xsdLocal:checkSequenceRequest>
      ...
      <xsdLocal:seqRequestDetails>
        <xsdLocal:context>
          <xsl:value-of select="string(&quot;SAPAM_EventManager&quot;)"/>
        </xsdLocal:context>
        <xsdLocal:contextId>
