  ...
  <xsl:template match="/">
    <xsdLocal:checkSequenceRequest>
      ...
      <xsdLocal:seqRequestDetails>
        <xsdLocal:context>
          <xsl:value-of select="dvm:lookupValue(&quot;oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm&quot;,&quot;Reference&quot;,&quot;SequenceContextForCPFG&quot;,&quot;Value&quot;,&quot;CPFGAccountManager&quot;)"/>
        </xsdLocal:context>
        <xsdLocal:messageType>
          <xsl:value-of select="dvm:lookupValue('oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm','Reference','SequencerMessageTypeCPFGAccount','Value','CPFGAccountDetails.MasterAccountID')"/>
        </xsdLocal:messageType>
        <xsdLocal:contextId>
          <xsl:value-of select="/local:accountPubRequest/local:account/local:masterAccountID"/>
        </xsdLocal:contextId>
        <xsdLocal:process>
          <xsl:value-of select="dvm:lookupValue('oramds:/apps/EAIMetaData/dvm/CRMAppReference.dvm','Reference','CPFGAccountManagerBPELProcess','Value','CPFGAM_AccountManager')"/>
        </xsdLocal:process>
